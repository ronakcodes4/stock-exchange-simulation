...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cancelOrder(dto1.getID(), BUY);
            cancelOrder(dto2.getID(), BUY);
            cancelOrder(dto3.getID(), BUY);
            printTopOfBook();
            printBook();
            ...
            cancelOrder(dto1.getID(), SELL);
            cancelOrder(dto2.getID(), SELL);
            cancelOrder(dto3.getID(), SELL);
            printTopOfBook();
            printBook();
    ...
    private static void cancelOrder(String getID, BookSide side) {
        try {
            productBook.cancel(side, getID);
        } catch (Exception e) {
